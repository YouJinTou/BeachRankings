namespace Services.Aggregation.RankCalculators
{
    ...
    internal class KayakingRankCalculator : RankCalculator
    {
        public KayakingRankCalculator(
        ...
        {
            var strategy = new KayakingCalculationStrategy();
            ...
            return new RankContainer
            {
                ...
                FilterType = BeachFilterType.Kayaking,
                FilterDescriptors = this.descriptor.GetFilterDescription(BeachFilterType.Kayaking),
                RankBy = "Kayaking",
