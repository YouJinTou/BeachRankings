namespace Services.Aggregation.RankCalculators
{
    ...
    internal class LongTermStayRankCalculator : RankCalculator
    {
        public LongTermStayRankCalculator(
        ...
        {
            var strategy = new LongTermStayCalculationStrategy();
            ...
            return new RankContainer
            {
                ...
                FilterType = BeachFilterType.LongTermStay,
                FilterDescriptors = this.descriptor.GetFilterDescription(BeachFilterType.LongTermStay),
                RankBy = "Long-term stay",
